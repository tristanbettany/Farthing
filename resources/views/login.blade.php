...
<body>
    <div class="flex flex-row justify-center flex-wrap sm:h-screen items-center">
        ...
        <div class="w-full sm:w-1/2 h-350px sm:h-screen bg-no-repeat bg-cover bg-bottom shadow-2xl filter grayscale" style="background-image: url({{ asset('img/banners/'. rand(1, 1) .'.jpg') }});">
        </div>
        ...
        <div class="w-full sm:w-1/2 p-20px sm:h-screen flex flex-col justify-center flex-wrap items-center text-center: sm:text-left">
            ...
            <div class="w-full flex flex-col justify-center flex-wrap items-center text-center">
                ...
                <div class="pb-40px">
                    <h1 class="text-60px tracking-widest">F<i class="text-ter-800 text-60px fas fa-coins"></i>RTHING</h1>
                </div>
